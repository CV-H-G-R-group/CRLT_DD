...
def main():
    ...
    channel, im_size, num_classes, class_names, mean, std, dst_train, dst_test, testloader = get_dataset(args.dataset, args.data_path, logger=logger, imb_factor=args.imb_factor)
    ...
    for exp in range(args.num_exp):
        ...
        for model_eval in model_eval_pool:
            ...
            for it_eval in range(args.num_eval):
                ...
                _, acc_train, acc_test = evaluate_synset(it_eval, net_eval, image_syn_eval, label_syn_eval, testloader, args, output_channel, logger, if_write_csv=True, csv_name = args.dataset + '_' + str(args.imb_factor) + "_LT")
